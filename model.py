...
class Seq2Seq(nn.Module):
    """
        ...
        Parameters:
            ...
            - `config`: configuaration of encoder model
            - `beam_size`: beam size of beam search
            - `max_length`: max length of target for beam search
            - `sos_id`: start of symbol ids in target for beam search
            - `eos_id`: end of symbol ids in target for beam searh
    """
    ...
    def _tie_or_clone_weights(self, first_module, second_module):
        """
            Tie of clone module weights depending of weither we are using TorchScipt or not
        """
    ...
    def forward(self, source_ids=None, source_mask=None, target_ids=None, target_mask=None, args=None):
        ...
        if target_ids is not None:
            ...
            for i in range(source_ids.shape[0]):
                ...
                pred.append(torch.cat(pred, 0).unsqueeze(0))
